...
<head>
    ...
    <title>{{ $title ?? 'Quiz' }} - {{ config('app.name','Laravel') }}</title>
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <div class="float-right d-none d-sm-block">
                <b><a href="https://www.linkedin.com/in/fatih-tuzlu-97b95b20a/">Fatih Tuzlu</a></b>
            </div>
            <strong>Powered by</strong> <a href="https://www.linkedin.com/in/fatih-tuzlu-97b95b20a/">Kontrol Paneli</a>
        </footer>
    </div>
